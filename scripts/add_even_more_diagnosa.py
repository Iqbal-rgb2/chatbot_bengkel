...
JSON_PATH = os.path.join(BASE_DIR, 'scripts', 'seeder_data', 'even_more_diagnosa.json')
with open(JSON_PATH, 'r', encoding='utf-8') as f:
    diagnosa_data = json.load(f)
even_more_diagnosa = [(item['kata_kunci'], item['gejala'], item['solusi_analisis']) for item in diagnosa_data]
